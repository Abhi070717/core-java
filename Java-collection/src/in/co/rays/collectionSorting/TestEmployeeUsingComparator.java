...
public class TestEmployeeUsingComparator {
	...
	public static void main(String[] args) {
		...
		OrderByIdAscending ById = new OrderByIdAscending();
		Collections.sort(list, ById);
		
		System.out.println(list);
		
		OrderByNameAscending ByName = new OrderByNameAscending();
		Collections.sort(list, ByName);
		System.out.println(list);
		
		OrderBySalaryAscending BySalary = new OrderBySalaryAscending();
